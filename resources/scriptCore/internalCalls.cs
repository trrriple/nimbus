...
public unsafe partial class InternalCalls
{
    ...
    public static partial bool KeyPressed(ScanCode scanCode);

    [return: MarshalAs(UnmanagedType.I1)]
    [LibraryImport("nimbus", EntryPoint = "ic_modKeyPressed")]
    public static partial bool ModKeyPressed(KeyMod keyMod);

    [return: MarshalAs(UnmanagedType.I1)]
    [LibraryImport("nimbus", EntryPoint = "ic_mouseButtonPressed")]
    public static partial bool MouseButtonPressed(MouseButton mouseButton);
