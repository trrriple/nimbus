...
namespace FileDialog {
	...
	bool ShowFileDialog(bool* open, char* buffer, [[maybe_unused]] unsigned int buffer_size, FileDialogType type = FileDialogType::OpenFile) {
		...
		// Trrriple Mod: making ShowFileDialog return if a file has been choosen, should only be true on call
		// where a successfully choose happened
