...
void Renderer2D::s_init()
{
                   ...
                   []()
    {
        ...
        // Quad data init
        ///////////////////////////
        s_quadData.p_shader = ResourceManager::get().loadShader(
        ...
        ref<Texture> whiteTexture 
            = makeRef<Texture>(Texture::Type::DIFFUSE, 1, 1, texSpec);
...
void Renderer2D::_s_createQuadBuffers()
{
    ...
    // (Re)make VAO
    ///////////////////////////
    s_quadData.p_vao = makeRef<VertexArray>();
    ...
    s_quadData.p_vbo
        = makeRef<VertexBuffer>(&s_quadData.vertices[0],
