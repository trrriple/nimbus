...
void Renderer2D::s_drawQuad(const glm::mat4& transform, const glm::vec4& color, uint32_t entityId)
{
    NM_PROFILE_TRACE();
...
static void s_generateIndicesAndSetBuffer(uint32_t quads, ref<VertexArray>& p_vao)
{
